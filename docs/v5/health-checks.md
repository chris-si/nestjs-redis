...
import { ClusterModule, RedisModule } from '@chris-si/nestjs-redis';
import { RedisHealthModule } from '@chris-si/nestjs-redis/health'; // note the import path
...
import { InjectRedis, InjectCluster } from '@chris-si/nestjs-redis';
import { RedisHealthIndicator } from '@chris-si/nestjs-redis/health'; // note the import path
