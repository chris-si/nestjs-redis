...
import { InjectCluster, DEFAULT_CLUSTER_NAMESPACE } from '@chris-si/nestjs-redis';
...
```TypeScript
import { Injectable } from '@nestjs/common';
import { ClusterService, DEFAULT_CLUSTER_NAMESPACE } from '@chris-si/nestjs-redis';
import { Cluster } from 'ioredis';
...
```TypeScript
import { Module } from '@nestjs/common';
import { ClusterModule, ClusterModuleOptions } from '@chris-si/nestjs-redis';
...
import { ClusterModule, ClusterOptionsFactory, ClusterModuleOptions } from '@chris-si/nestjs-redis';
