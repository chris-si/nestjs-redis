...
import { InjectRedis, DEFAULT_REDIS_NAMESPACE } from '@chris-si/nestjs-redis';
...
```TypeScript
import { Injectable } from '@nestjs/common';
import { RedisService, DEFAULT_REDIS_NAMESPACE } from '@chris-si/nestjs-redis';
import { Redis } from 'ioredis';
...
```TypeScript
import { Module } from '@nestjs/common';
import { RedisModule, RedisService, DEFAULT_REDIS_NAMESPACE } from '@chris-si/nestjs-redis';
...
```TypeScript
import { Module } from '@nestjs/common';
import { RedisModule, RedisModuleOptions } from '@chris-si/nestjs-redis';
...
import { RedisModule, RedisOptionsFactory, RedisModuleOptions } from '@chris-si/nestjs-redis';
