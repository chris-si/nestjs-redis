...
<div align="center">
  ...
  <p align="center">
    Redis(ioredis) module for Nest framework v10 (node.js) based on <a href="https://github.com/chris-si/nestjs-redis">@liaoliaots/nestjs-redis</a>
    <br />
    ...
    ·
    <a href="https://github.com/chris-si/nestjs-redis/issues/new/choose">Report Bug</a>
    ·
...
This lib requires **Node.js >=18.0.0**, **NestJS ^10.0.0**, **ioredis ^5.0.0**.

- If you depend on **ioredis 4**, please use [version 7](https://github.com/chris-si/nestjs-redis/tree/v7.0.0) of the lib.
- If you depend on **ioredis 5**, **NestJS 7** or **8**, please use [version 8](https://github.com/chris-si/nestjs-redis/tree/v8.2.2) of the lib.

### Installation

```sh
# with npm
npm install @chris-si/nestjs-redis ioredis
# with yarn
yarn add @chris-si/nestjs-redis ioredis
# with pnpm
pnpm add @chris-si/nestjs-redis ioredis
```
...
import { RedisModuleOptions, RedisOptionsFactory } from '@chris-si/nestjs-redis';
...
[npm-shield]: https://img.shields.io/npm/v/@chris-si/nestjs-redis/latest?style=for-the-badge
[npm-url]: https://www.npmjs.com/package/@chris-si/nestjs-redis
[downloads-shield]: https://img.shields.io/npm/dm/@chris-si/nestjs-redis?style=for-the-badge
[downloads-url]: https://www.npmjs.com/package/@chris-si/nestjs-redis
...
[vulnerabilities-shield]: https://img.shields.io/snyk/vulnerabilities/npm/@chris-si/nestjs-redis?style=for-the-badge
[workflow-shield]: https://img.shields.io/github/actions/workflow/status/chris-si/nestjs-redis/testing.yaml?label=TESTING&style=for-the-badge
[workflow-url]: https://github.com/chris-si/nestjs-redis/actions/workflows/testing.yaml
